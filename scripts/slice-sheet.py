...
Backgrounds handled automatically:
  * real alpha (a transparent PNG)          -> used as-is
  * flat black / near-black                 -> keyed out
  * the grey checkerboard some tools bake in -> keyed out
