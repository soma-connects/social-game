  ...
  const renderSpeaking = () => {
    ...
    return (
      ...
      >
        ...
        {isMyDebateTurn ? (
          /*
           * Arguing is a spoken act, so the mic is the button and the keyboard
           * is the escape hatch — the same inversion Story Builder needed. A
           * debate typed out at thumb speed is not a debate, and the other
           * players are sitting on a live call waiting for it.
           */
          <div className="flex flex-col gap-3 mt-4">
            ...
            >
              <p className={`text-lg ${argument ? 'text-white font-bold' : 'text-gray-500'}`}>
                {argument || (isRecording ? 'Listening…' : 'Tap below and state your case')}
              </p>
            </div>
            ...
            >
              ...
              {isRecording ? 'LISTENING — TAP TO STOP' : argument ? 'SAY IT AGAIN' : 'TAP TO ARGUE'}
            </button>
            ...
            {showTyping ? (
              <input
                ...
                /* Matches the server's cap, so a long argument is stopped here
                   rather than silently truncated after they hit submit. */
                maxLength={400}
                autoFocus
                placeholder="Type your case instead…"
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <h2 className="text-3xl font-black text-white text-center">Who won the debate? 🎤</h2>
