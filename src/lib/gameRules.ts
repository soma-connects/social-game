...
export const BOARD_GRAPH: Record<number, BoardNode> = {
  0: { id: 0, type: 'normal', next: [24], x: 20, y: 86 },
  1: { id: 1, type: 'buff', next: [27], x: 4.4, y: 76.5 },
  2: { id: 2, type: 'normal', next: [30], x: 0.4, y: 59.5 },
  3: { id: 3, type: 'dare', next: [33, 45], x: 10, y: 44 },
  4: { id: 4, type: 'normal', next: [36], x: 26.2, y: 35.3 },
  5: { id: 5, type: 'buff', next: [39], x: 43.9, y: 30.8 },
  6: { id: 6, type: 'mystery', next: [42], x: 62.3, y: 31.2 },
  7: { id: 7, type: 'debuff', next: [48], x: 16.4, y: 26.8 },
  8: { id: 8, type: 'trap', next: [51], x: 25.6, y: 10.9 },
  9: { id: 9, type: 'duel', next: [54], x: 40.5, y: 1 },
  10: { id: 10, type: 'bonus', next: [57], x: 57.3, y: 7.2 },
  11: { id: 11, type: 'dare', next: [60], x: 69.8, y: 20.7 },
  12: { id: 12, type: 'normal', next: [63], x: 80, y: 36 },
  13: { id: 13, type: 'mystery', next: [66], x: 95.6, y: 44.1 },
  14: { id: 14, type: 'debuff', next: [69, 81], x: 88, y: 60 },
  15: { id: 15, type: 'bonus', next: [72], x: 76.1, y: 73.9 },
  16: { id: 16, type: 'trap', next: [75], x: 59.7, y: 81.9 },
  17: { id: 17, type: 'duel', next: [78], x: 41.7, y: 79.5 },
  18: { id: 18, type: 'dare', next: [84], x: 81.2, y: 77.1 },
  19: { id: 19, type: 'buff', next: [87], x: 70.2, y: 91.6 },
  20: { id: 20, type: 'normal', next: [90], x: 52.9, y: 94.4 },
  21: { id: 21, type: 'mystery', next: [93], x: 37.8, y: 84.1 },
  22: { id: 22, type: 'buff', next: [96], x: 26, y: 70 },
  23: { id: 23, type: 'normal', next: [], x: 30, y: 52 },
  24: { id: 24, type: 'empty', next: [25], x: 15.8, y: 84.2 },
  25: { id: 25, type: 'empty', next: [26], x: 11.7, y: 82.1 },
  26: { id: 26, type: 'empty', next: [1], x: 7.9, y: 79.5 },
  27: { id: 27, type: 'empty', next: [28], x: 1.6, y: 72.8 },
  28: { id: 28, type: 'empty', next: [29], x: -0.1, y: 68.6 },
  29: { id: 29, type: 'empty', next: [2], x: -0.5, y: 64 },
  30: { id: 30, type: 'empty', next: [31], x: 2.1, y: 55.2 },
  31: { id: 31, type: 'empty', next: [32], x: 4.4, y: 51.3 },
  32: { id: 32, type: 'empty', next: [3], x: 7, y: 47.5 },
  33: { id: 33, type: 'empty', next: [34], x: 13.9, y: 41.5 },
  34: { id: 34, type: 'empty', next: [35], x: 17.8, y: 39.2 },
  35: { id: 35, type: 'empty', next: [4], x: 21.9, y: 37.1 },
  36: { id: 36, type: 'empty', next: [37], x: 30.5, y: 33.7 },
  37: { id: 37, type: 'empty', next: [38], x: 34.9, y: 32.4 },
  38: { id: 38, type: 'empty', next: [5], x: 39.4, y: 31.4 },
  39: { id: 39, type: 'empty', next: [40], x: 48.5, y: 30.4 },
  40: { id: 40, type: 'empty', next: [41], x: 53.1, y: 30.4 },
  41: { id: 41, type: 'empty', next: [6], x: 57.7, y: 30.6 },
  42: { id: 42, type: 'empty', next: [43], x: 66.8, y: 32 },
  43: { id: 43, type: 'empty', next: [44], x: 71.3, y: 33.1 },
  44: { id: 44, type: 'empty', next: [12], x: 75.7, y: 34.4 },
  45: { id: 45, type: 'empty', next: [46], x: 11.4, y: 39.6 },
  46: { id: 46, type: 'empty', next: [47], x: 13, y: 35.3 },
  47: { id: 47, type: 'empty', next: [7], x: 14.6, y: 31 },
  48: { id: 48, type: 'empty', next: [49], x: 18.4, y: 22.6 },
  49: { id: 49, type: 'empty', next: [50], x: 20.5, y: 18.5 },
  50: { id: 50, type: 'empty', next: [8], x: 22.9, y: 14.6 },
  51: { id: 51, type: 'empty', next: [52], x: 28.6, y: 7.4 },
  52: { id: 52, type: 'empty', next: [53], x: 32.1, y: 4.4 },
  53: { id: 53, type: 'empty', next: [9], x: 36.1, y: 2.2 },
  54: { id: 54, type: 'empty', next: [55], x: 45.1, y: 1.1 },
  55: { id: 55, type: 'empty', next: [56], x: 49.5, y: 2.4 },
  56: { id: 56, type: 'empty', next: [10], x: 53.6, y: 4.6 },
  57: { id: 57, type: 'empty', next: [58], x: 60.8, y: 10.3 },
  58: { id: 58, type: 'empty', next: [59], x: 64, y: 13.6 },
  59: { id: 59, type: 'empty', next: [11], x: 67, y: 17 },
  60: { id: 60, type: 'empty', next: [61], x: 72.6, y: 24.4 },
  61: { id: 61, type: 'empty', next: [62], x: 75.1, y: 28.2 },
  62: { id: 62, type: 'empty', next: [12], x: 77.6, y: 32.1 },
  63: { id: 63, type: 'empty', next: [64], x: 84.5, y: 36.9 },
  64: { id: 64, type: 'empty', next: [65], x: 88.9, y: 38.3 },
  65: { id: 65, type: 'empty', next: [13], x: 92.9, y: 40.5 },
  66: { id: 66, type: 'empty', next: [67], x: 95.6, y: 48.7 },
  67: { id: 67, type: 'empty', next: [68], x: 93.8, y: 52.8 },
  68: { id: 68, type: 'empty', next: [14], x: 91.1, y: 56.6 },
  69: { id: 69, type: 'empty', next: [70], x: 85.4, y: 63.8 },
  70: { id: 70, type: 'empty', next: [71], x: 82.5, y: 67.4 },
  71: { id: 71, type: 'empty', next: [15], x: 79.4, y: 70.8 },
  72: { id: 72, type: 'empty', next: [73], x: 72.4, y: 76.7 },
  73: { id: 73, type: 'empty', next: [74], x: 68.4, y: 79 },
  74: { id: 74, type: 'empty', next: [16], x: 64.2, y: 80.8 },
  75: { id: 75, type: 'empty', next: [76], x: 55.1, y: 82.2 },
  76: { id: 76, type: 'empty', next: [77], x: 50.6, y: 81.9 },
  77: { id: 77, type: 'empty', next: [17], x: 46.1, y: 80.9 },
  78: { id: 78, type: 'empty', next: [79], x: 37.5, y: 77.5 },
  79: { id: 79, type: 'empty', next: [80], x: 33.5, y: 75.3 },
  80: { id: 80, type: 'empty', next: [22], x: 29.7, y: 72.8 },
  81: { id: 81, type: 'empty', next: [82], x: 86.5, y: 64.4 },
  82: { id: 82, type: 'empty', next: [83], x: 84.9, y: 68.7 },
  83: { id: 83, type: 'empty', next: [18], x: 83.1, y: 72.9 },
  84: { id: 84, type: 'empty', next: [85], x: 79, y: 81.1 },
  85: { id: 85, type: 'empty', next: [86], x: 76.4, y: 84.9 },
  86: { id: 86, type: 'empty', next: [19], x: 73.6, y: 88.5 },
  87: { id: 87, type: 'empty', next: [88], x: 66.3, y: 94.1 },
  88: { id: 88, type: 'empty', next: [89], x: 61.9, y: 95.4 },
  89: { id: 89, type: 'empty', next: [20], x: 57.3, y: 95.5 },
  90: { id: 90, type: 'empty', next: [91], x: 48.7, y: 92.5 },
  91: { id: 91, type: 'empty', next: [92], x: 44.8, y: 90.1 },
  92: { id: 92, type: 'empty', next: [21], x: 41.2, y: 87.2 },
  93: { id: 93, type: 'empty', next: [94], x: 34.7, y: 80.7 },
  94: { id: 94, type: 'empty', next: [95], x: 31.6, y: 77.3 },
  95: { id: 95, type: 'empty', next: [22], x: 28.8, y: 73.7 },
  96: { id: 96, type: 'empty', next: [97], x: 27, y: 65.5 },
  97: { id: 97, type: 'empty', next: [98], x: 28, y: 61 },
  98: { id: 98, type: 'empty', next: [23], x: 29, y: 56.5 },
};
